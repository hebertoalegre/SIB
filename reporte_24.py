...
#########################LEER ARCHIVOS###########################
route = os.path.abspath('temporaly\consulta_24')
...
for file in tqdm(files):
    ...
    df['FECHA'] = fecha
    df['MONEDA'] = 'AMBAS'
    df['ORIGEN'] = 'INTEGRACION DE LA CARTERA'
...
print(todo)
todo.to_excel(os.path.join(os.path.abspath('outputs'),'reporte_24.xlsx'), index=False)
