...
#########################LEER ARCHIVOS###########################
route = os.path.abspath('temporaly\consulta_37')
...
for file in tqdm(files):
    ...
    df['FECHA'] = fecha
    df['MONEDA'] = 'AMBAS'
    df['ORIGEN'] = 'INTEGRACION DE FIDEICOMISOS'
...
print(todo)
todo.to_excel(os.path.join(os.path.abspath('outputs'),'reporte_37.xlsx'), index=False)
